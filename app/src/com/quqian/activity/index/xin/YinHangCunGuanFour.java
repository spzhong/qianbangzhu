...
public class YinHangCunGuanFour extends BaseActivity implements OnClickListener{

	@Override
	protected int layoutId() {
		// TODO Auto-generated method stub
		return R.layout.main_index_xin_yinhangcunguanfour;
	}
	...
	public void onClick(View arg0) {
		...
		case R.id.title_bar_back:
			// 返回
			YinHangCunGuanFour.this.finish();
			anim_right_out();
			break;
		default:
			break;
