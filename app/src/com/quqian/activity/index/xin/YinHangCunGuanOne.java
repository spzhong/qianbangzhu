...
public class YinHangCunGuanOne extends BaseActivity implements OnClickListener{
	...
	protected int layoutId() {
		...
		return R.layout.main_index_xin_yinhangcunguanone;
	}
	...
	protected void initView() {
		...
		next = (Button)findViewById(R.id.yhcg_next1);
	...
	public void onClick(View arg0) {
		...
		case R.id.title_bar_back:
			// 返回
			YinHangCunGuanOne.this.finish();
			anim_right_out();
			break;
		case R.id.yhcg_next1:
			// 返回
			startActivity(new Intent(YinHangCunGuanOne.this,YinHangCunGuanTwo.class));
			anim_right_in();
			break;
		default:
			break;
