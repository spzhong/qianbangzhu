...
public class WuYouCunZhengTwo extends BaseActivity implements OnClickListener{
	...
	protected int layoutId() {
		...
		return R.layout.main_index_xin_wuyoucunzhengtwo;
	}
	...
	protected void initView() {
		...
		next = (Button)findViewById(R.id.wzcy_next2);
	...
	public void onClick(View arg0) {
		...
		case R.id.title_bar_back:
			// 返回
			WuYouCunZhengTwo.this.finish();
			anim_right_out();
			break;
		case R.id.wzcy_next2:
			// 返回
			startActivity(new Intent(WuYouCunZhengTwo.this,WuYouCunZhengThree.class));
			anim_right_in();
			break;
		default:
			break;
