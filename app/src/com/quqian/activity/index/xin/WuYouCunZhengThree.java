...
public class WuYouCunZhengThree extends BaseActivity implements OnClickListener{
	...
	protected int layoutId() {
		...
		return R.layout.main_index_xin_wuyoucunzhengthree;
	}
	...
	protected void initView() {
		...
		next = (Button)findViewById(R.id.wzcy_next3);
	...
	public void onClick(View arg0) {
		...
		case R.id.title_bar_back:
			// 返回
			WuYouCunZhengThree.this.finish();
			anim_right_out();
			break;
		case R.id.wzcy_next3:
			// 返回
			startActivity(new Intent(WuYouCunZhengThree.this,WuYouCunZhengFour.class));
			anim_right_in();
			break;
		default:
			break;
