...
public class YinHangCunGuanThree extends BaseActivity implements OnClickListener{
	...
	protected int layoutId() {
		...
		return R.layout.main_index_xin_yinhangcunguanthree;
	}
	...
	protected void initView() {
		...
		next = (Button)findViewById(R.id.yhcg_next3);
	...
	public void onClick(View arg0) {
		...
		case R.id.title_bar_back:
			// 返回
			YinHangCunGuanThree.this.finish();
			anim_right_out();
			break;
		case R.id.yhcg_next3:
			// 返回
			startActivity(new Intent(YinHangCunGuanThree.this,YinHangCunGuanFour.class));
			anim_right_in();
			break;
		default:
			break;
