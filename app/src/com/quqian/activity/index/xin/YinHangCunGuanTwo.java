...
public class YinHangCunGuanTwo extends BaseActivity implements OnClickListener{
	...
	protected int layoutId() {
		...
		return R.layout.main_index_xin_yinhangcunguantwo;
	}
	...
	protected void initView() {
		...
		next = (Button)findViewById(R.id.yhcg_next2);
	...
	public void onClick(View arg0) {
		...
		case R.id.title_bar_back:
			// 返回
			YinHangCunGuanTwo.this.finish();
			anim_right_out();
			break;
		case R.id.yhcg_next2:
			// 返回
			startActivity(new Intent(YinHangCunGuanTwo.this,YinHangCunGuanThree.class));
			anim_right_in();
			break;
		default:
			break;
