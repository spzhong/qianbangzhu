...
public class SanBiaoTouZiActivity extends BaseActivity implements
	...
	protected int layoutId() {
		...
		return R.layout.main_index_sanbiaotouzi;
	}
	...
	protected void initView() {
		...
		juhua = new ProcessDialogUtil(SanBiaoTouZiActivity.this);

		// initList();
		mListView = (XListView) findViewById(R.id.index_sanbiao_listview);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				// TODO Auto-generated method stub
				if (position != 0) {
					UserMode user = Tool.getUser(SanBiaoTouZiActivity.this);
					if (user == null) {
						startActivity(new Intent(SanBiaoTouZiActivity.this,
								LoginActivity.class));
					} else {
						SanProject san = (SanProject) allList.get(position - 1);
						Intent intent = new Intent(SanBiaoTouZiActivity.this,
	...
	public void onClick(View arg0) {
		...
		case R.id.title_bar_back:
			SanBiaoTouZiActivity.this.finish();
			anim_right_out();
			break;
		default:
			break;
	...
	class MyAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(SanBiaoTouZiActivity.this)
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case 0:
				Toast.makeText(SanBiaoTouZiActivity.this,
	...
	private void loadHttp() {
		...
		RequestThreadAbstract thread = RequestFactory.createRequestThread(8,
				map, SanBiaoTouZiActivity.this, mHandler);
