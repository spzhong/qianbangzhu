...
public class TiXianJILu extends BaseActivity implements OnClickListener,
	...
	protected int layoutId() {
		...
		return R.layout.mine_new_tixianjilu;
	}
	...
	protected void initView() {
		...
		juhua = new ProcessDialogUtil(TiXianJILu.this);

		rg = (RadioGroup) findViewById(R.id.txjl_rg);
		rb1 = (RadioButton) findViewById(R.id.txjl_rb1);
		rb2 = (RadioButton) findViewById(R.id.txjl_rb2);

		// 单选按钮下面的选中条
		tvrb1 = (TextView) findViewById(R.id.txjl_tvrb1);
		tvrb2 = (TextView) findViewById(R.id.txjl_tvrb2);

		mListView = (XListView) findViewById(R.id.txjl_listview);
