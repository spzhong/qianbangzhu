...
public class ZhaoHuiTiXianMiMaActivity extends BaseActivity implements
	...
	protected int layoutId() {
		...
		return R.layout.main_mine_zhaohuitixianmima;
	}
	...
	protected void initView() {
		...
		juhua = new ProcessDialogUtil(ZhaoHuiTiXianMiMaActivity.this);
		
		shouji = (TextView) findViewById(R.id.main_mine_zhaohuitixianmima_shoujihao);
		yanzhengma = (EditText) findViewById(R.id.main_mine_zhaohuitixianmima_et);
		next = (Button) findViewById(R.id.main_mine_zhaohuitixianmima_next);
		huoqu = (Button) findViewById(R.id.main_mine_zhaohuitixianmima_huoqu);
		
		UserMode user = Tool.getUser(ZhaoHuiTiXianMiMaActivity.this);
	...
	public void onClick(View arg0) {
		...
		case R.id.title_bar_back:
			ZhaoHuiTiXianMiMaActivity.this.finish();
			anim_right_out();
			break;
		case R.id.main_mine_zhaohuitixianmima_huoqu:
			// 获取验证码
			loadHttp_mesgCode();
			break;
		case R.id.main_mine_zhaohuitixianmima_next:
			loadHttp_next();
			break;
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				Toast.makeText(ZhaoHuiTiXianMiMaActivity.this,
			...
			case 1:// 获取短信验证码
				...
				break;
			case 3:// 下一步验证
				Intent intent = new Intent(ZhaoHuiTiXianMiMaActivity.this, ChongZhiTiXianMiMaActivity.class);
	...
	private void loadHttp_mesgCode() {
		...
		RequestThreadAbstract thread = RequestFactory.createRequestThread(5,
				map, ZhaoHuiTiXianMiMaActivity.this, mHandler);
