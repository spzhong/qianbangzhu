...
public class WheelView extends View {
    ...
    private static final int VALUE_TEXT_COLOR = 0xFF4F5257;

    /** Items text color */
    private static final int ITEMS_TEXT_COLOR = 0xFFC7C7C7;

    /** Top and bottom shadows colors */
    private static final int[] SHADOWS_COLORS = new int[] { 0xFFFFFFFF,0x00FFFFFF, };

    /** Additional items height (is added to standard text item height) */
    private static final int ADDITIONAL_ITEM_HEIGHT = 15;

    /** Item Text size */
    private static final int ITEM_TEXT_SIZE = 18;
    
    /** Value Text size */
    private static final int VALUE_TEXT_SIZE = 20;

    /** Top and bottom items offset (to hide that) */
    private static final int ITEM_OFFSET = ITEM_TEXT_SIZE / 5;
    ...
    public int getItem(int index) {
    	int item = Integer.valueOf(getAdapter().getItem(index));
        return item;
    }
...
//            itemsPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG | Paint.FAKE_BOLD_TEXT_FLAG);
            ...
            itemsPaint.setTextSize(ConvertUtil.dip2px(getContext(), ITEM_TEXT_SIZE));
        }

        if (valuePaint == null) {
            valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG | Paint.DITHER_FLAG);
            // valuePaint.density = getResources().getDisplayMetrics().density;
            valuePaint.setTextSize(ConvertUtil.dip2px(getContext(), VALUE_TEXT_SIZE));
