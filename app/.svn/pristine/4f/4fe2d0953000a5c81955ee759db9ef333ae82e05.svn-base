package com.quqian.lock.widget;
...
import com.quqian.lock.common.AppUtil;
import com.quqian.lock.common.Constants;
import com.quqian.lock.entiry.GesturePoint;
...
public class GestureDrawline extends View {
	...
	public GestureDrawline(Context context, List<GesturePoint> list, boolean isVerify,
		...
		paint.setColor(getResources().getColor(R.color.main_blue));// 设置默认连线颜色
