...
-(void)remove{
    ...
    UIView *b = [[UIApplication sharedApplication].keyWindow viewWithTag:1999009];
...
-(void)show{
    ...
    UIView *b = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, 600)];
    [b setBackgroundColor:[UIColor blackColor]];
    b.alpha = 0.5;
    b.tag=1999009;
    [[UIApplication sharedApplication].keyWindow addSubview:b];
