...
static const CGFloat kPadding = 5.f;
static const CGFloat kLabelFontSize = 11.f;
...
- (void)setupLabels {
	label = [[UILabel alloc] initWithFrame:CGRectMake(self.bounds.origin.x-10, self.bounds.origin.y, self.bounds.size.width+20, self.bounds.size.height+30)];
    ...
    label.text = self.detailsLabelText;
