...
{
    UILabel *titlelabel = [[UILabel alloc] initWithFrame:CGRectMake(TITLE_INTERVAL_WIDTH, TITLE_INTERVAL_HEIGHT, [Tool adaptation:TITLE_WIDTH with6:55 with6p:94], TITLE_HEIGHT)];
...
{
    UIButton *destructiveButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT, [Tool adaptation:260 with6:55 with6p:94], BUTTON_HEIGHT)];
...
{
    UIButton *otherButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT + (postionIndex*(BUTTON_HEIGHT+(BUTTON_INTERVAL_HEIGHT/2))), [Tool adaptation:260 with6:55 with6p:94], BUTTON_HEIGHT)];
...
{
    UIButton *cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT, [Tool adaptation:260 with6:55 with6p:94], BUTTON_HEIGHT)];
